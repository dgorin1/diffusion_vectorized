...
nameOfInputCSVFile =  f"{dir_path}/data/3DomSynthDataNoisyM3_plane_sheet_noextrasteps.csv"
nameOfExperimentalResultsFile = f"{dir_path}/data/input_3DomSynthDataNoisyM3_plane_sheet_noextrasteps.csv"
