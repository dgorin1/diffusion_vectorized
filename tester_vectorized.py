...
data_input = pd.read_csv(f"{dir_path}/data/input_KM95-6-Da-1107um.csv")
mineral_name = "quartz"
time_add = [3600*5, 112665600] #Add extra time in seconds
temp_add = [40,21.11111111]
sample_name = "input_KM95-6-Da-1107um-REDO-nolookuptable"
...
misfit_stat_list = ["percent_frac","lnd0aa","chisq","l1_moles","l2_moles","l1_frac","l2_frac"] #ADD BACK PERCENT_FRAC. #options are chisq, l1_moles, l2_moles, l1_frac, l2_frac, percent_frac
