...
data_input = pd.read_csv(f"{dir_path}/data/input_KM95-20-Da-665um.csv")
mineral_name = "quartz"
time_add = [3600*5,86918400] #Add extra time in seconds
temp_add = [40,21.111111111]
sample_name = "KM95-20-Da-665_REDO_nolookuptable"
