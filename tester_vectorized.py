...
data_input = pd.read_csv(f"{dir_path}/data/input_KM95-15-Dc-1308um.csv")
mineral_name = "quartz"
time_add = [300*60,111801600] #Add extra time in seconds
temp_add = [40,21.11111111]
sample_name = "KM95-15-Dc-REDO-nolookuptable"
...
misfit_stat_list = ["lnd0aa","percent_frac","chisq","l1_moles","l2_moles","l1_frac","l2_frac"] #ADD BACK PERCENT_FRAC. #options are chisq, l1_moles, l2_moles, l1_frac, l2_frac, percent_frac
