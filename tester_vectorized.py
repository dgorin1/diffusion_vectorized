...
data_input = pd.read_csv(f"{dir_path}/data/input_n13ksp_moles_combined_final_step.csv")
mineral_name = "kspar"
time_add = [] #Add extra time in seconds
temp_add = []
sample_name = "input_n13ksp_moles_combined_final_step"
...
omit_value_indices = [33]#[33,34,35,36,37,38,39,40,41] #[]#[0,1,2]#

misfit_stat_list = ["lnd0aa_chisq","chisq","percent_frac","l1_frac_cum","l1_frac"] # #ADD BACK PERCENT_FRAC. #options are chisq, l1_moles, l2_moles, l1_frac, l2_frac, percent_frac
