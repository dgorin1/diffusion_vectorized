...
data_input = pd.read_csv(f"{dir_path}/data/input_KM95-15-De-897um.csv")
mineral_name = "quartz"
time_add = [3600*5, 115603200] #Add extra time in seconds
temp_add = [40,21.11111111]
sample_name = "KM95-15-De-897um-REDO-nolookuptable"
